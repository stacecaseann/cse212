...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Items are being added in the wrong order, at the start of the queue instead of the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There is no code to add enqueue a person if they are set up as having infinite turns.
